        ...
        <nav className="mx-auto flex items-center justify-between px-6 py-4 max-w-7xl">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              ...
              className="bg-green-600 cursor-pointer hover:bg-green-700 text-white font-bold px-4 py-2 rounded-4xl transition-all hover:scale-105 w-auto"
            >
              Get Started
            </button>
          </div>
          ...
          {isMenuOpen && (
            ...
            >
              ...
              <button
                onClick={() => setIsModalOpen(true)}
                className="bg-green-600 cursor-pointer hover:bg-green-700 text-center hover:text-black text-white font-bold px-6 py-3 rounded-full transition-all hover:scale-105 w-auto"
              >
                Get Started
              </button>
            </div>
